...
class NewBirthdayHome extends StatelessWidget {
  get child => null;
            ...
            child: GridView.count(
              ...
              children: [
                ...
                _cakeCard(
                    ...
                    "assets/cakecategories/birthdaycakes/cake4.jpg",
                    'Rs.2500',
                    context),
                _cakeCard(
                    'Structured princess cake',
                    "assets/cakecategories/birthdaycakes/Special.png",
                    'Rs.2500',
                    context),
                _cakeCard(
                    'Chocolate Cake birthd',
                    "assets/cakecategories/birthdaycakes/Cake1.jpg",
                    'Rs.2500',
                    context),
                _cakeCard(
                    'Simple rounded birthday cake',
                    "assets/cakecategories/birthdaycakes/cake3.jpg",
                    'Rs.2500',
                    context),
                _cakeCard(
                    'Pincess birthday',
                    "assets/cakecategories/birthdaycakes/cake5.jpg",
                    'Rs.2500',
                    context),
                _cakeCard(
                    'Pink mashmelos structured cake',
                    "assets/cakecategories/birthdaycakes/cake2.jpg",
                    'Rs.2500',
                    context),
              ],
            ),
