            ...
            child: GridView.count(
              ...
              children: [
                ...
                _cakeCard(
                    ...
                    "assets/cakecategories/weddingCakes/cake1.jpg",
                    'Rs.2500',
                    context),
                _cakeCard(
                    'Structured princess cake',
                    "assets/cakecategories/weddingCakes/cake2.jpg",
                    'Rs.2500',
                    context),
                _cakeCard(
                    'Chocolate Cake birthd',
                    "assets/cakecategories/weddingCakes/cake3.jpg",
                    'Rs.2500',
                    context),
                _cakeCard(
                    'Simple rounded birthday cake',
                    "assets/cakecategories/weddingCakes/cake4.jpg",
                    'Rs.2500',
                    context),
              ],
            ),
